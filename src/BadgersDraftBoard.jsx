...
const INITIAL = [
  ...
  { id: 'cooper', tier: 2, name: 'Omar Cooper Jr.', pos: 'WR', team: 'NYJ', college: 'Indiana', pick: 30, s: ['REC  — 2023: 18-267-2TD (14.8) | 2024: 28-594-?TD | 2025: 58-804-?TD', 'RUSH — 75-yd rush TD (2025), longest by IU WR since 2014', 'MISC — PFF 87.8 grade in 2025, 4 career 100-yd games'] },
  ...
  { id: 'beck', tier: 7, name: 'Carson Beck', pos: 'QB', team: 'ARI', college: 'Miami', pick: 65, s: ['PASS — 2024 (UGA): 3,485 yds, 28 TD, 12 INT, 64.2% | 2025 (Miami): 3,813 yds, 30 TD, 12 INT, 72.4%', 'RUSH — 2024: 28-(-18)-0TD | 2025: 34-12-1TD', 'MISC — Georgia → Miami transfer, classic pocket passer'] },
  { id: 'allar', tier: 7, name: 'Drew Allar', pos: 'QB', team: 'PIT', college: 'Penn State', pick: 76, s: ['PASS — 2024: 3,327 yds, 24 TD, 8 INT, 63.4% | 2025: 1,100 yds, 8 TD, 3 INT (9 games)', 'RUSH — 2024: 52-82-3TD | 2025: limited', 'MISC — Broken ankle Nov 2025 (season-ending surgery), PSU career 7,402 yds/61 TD'] },
  { id: 'klubnik', tier: 7, name: 'Cade Klubnik', pos: 'QB', team: 'NYJ', college: 'Clemson', pick: 110, s: ['PASS — 2025: 2,943 yds, 16 TD, 6 INT, 63.9%', 'RUSH — 2025: 78-284-5TD (3.6)', 'MISC — Clemson starter, dual-threat ability, regressed in 2025'] },
  { id: 'payton', tier: 7, name: 'Cole Payton', pos: 'QB', team: 'PHI', college: 'NDSU', pick: 178, s: ['PASS — 2025: 2,719 yds, 16 TD, 4 INT, 72.0%', 'RUSH — 2025: 136-777-13TD (5.7)', 'MISC — NDSU dual-threat, FCS 1st-team AA, Walter Payton Award finalist'] },
  { id: 'green', tier: 7, name: 'Taylen Green', pos: 'QB', team: 'CLE', college: 'Arkansas', pick: 182, s: ['PASS — 2025: 2,714 yds, 19 TD, 11 INT, 60.7%', 'RUSH — 2025: 139-777-8TD (5.6)', 'MISC — Boise State → Arkansas, dual-threat, 6 games of 300+ pass yds in 2025'] },
  { id: 'kaliakmanis', tier: 7, name: 'Athan Kaliakmanis', pos: 'QB', team: 'WAS', college: 'Rutgers', pick: 223, s: ['PASS — 2025: 3,124 yds, 20 TD, 7 INT (best season of career)', 'RUSH — 2025: 56-98-2TD', 'MISC — Minnesota → Rutgers, career 8,604 yds/55 TDs in 48 games'] },
  ...
  { id: 'stowers', tier: 7, name: 'Eli Stowers', pos: 'TE', team: 'PHI', college: 'Vanderbilt', pick: 54, s: ['REC  — 2024: 50-644-5TD (12.9) | 2025: 62-769-4TD (12.4)', 'RUSH — 2-8-0TD (career)', 'MISC — Texas A&M → Vandy, Mackey Award winner (2025), 1st-team AA'] },
